...
module.exports = {
    up: (queryInterface, dataTypes) => __awaiter(void 0, void 0, void 0, function* () {
        yield queryInterface.createTable(constants_1.DataBaseTableNames.CAMPAIGN, {
            id: {
                allowNull: false,
                autoIncrement: true,
                primaryKey: true,
    ...
    down: (queryInterface, Sequelize) => __awaiter(void 0, void 0, void 0, function* () {
        const migration = (options) => __awaiter(void 0, void 0, void 0, function* () {
            yield queryInterface.dropTable(constants_1.DataBaseTableNames.CAMPAIGN, options);
        });
